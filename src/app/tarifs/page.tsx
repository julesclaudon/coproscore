...
function TarifsContent() {
  ...
  const proPrice = annual ? "24,17" : "29";
  const proCta = annual
    ? "S’abonner — 290 €/an"
    : "S’abonner — 29 €/mois";
                      ...
                      <div className="min-h-[3.5rem]">
                        ...
                        <div
                          className={`overflow-hidden transition-all duration-300 ease-in-out ${
                            annual ? "mt-1 max-h-8 opacity-100" : "max-h-0 opacity-0"
                          }`}
                        >
                          <p className="text-sm text-slate-400">
                            facturé 290&nbsp;&euro;/an
                            <span className="ml-2 inline-block rounded-full bg-teal-500/20 px-2.5 py-0.5 text-xs font-semibold text-teal-400">
                              Économisez 58&nbsp;&euro;
                            </span>
                          </p>
                        </div>
